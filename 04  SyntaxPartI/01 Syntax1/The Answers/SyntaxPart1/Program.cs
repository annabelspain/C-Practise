...
namespace SyntaxPart1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            decimal pi = 3.14159;       // 4) either change to double or sufix with 
            ...
            int requiredNumberOfAxles = (int)(kerbWeight / maxWeightPerAxle); // 8) You need the result cast to integer, not kerbWeight
        ...
        SW1A 2AA";
            ...
            string moreLotteryNumbers = string.Format("Next weeks winning lottery numbers are {0}, {1}, {2}, {3}, {4}, {5}", win1, win2, win3, win4, win5);
