...
{            
    class Program
    {
        static void Main(string[] args)
        {
            ...
            decimal salary = 50000.50M;   // 3) the decimal type should be used for money, then suffix with 
            double pi = 3.14159;       // 4) either change to double or sufix with 
            ...
            int requiredNumberOfAxles = (int)(kerbWeight / maxWeightPerAxle); // 8) Compiler will not silently cast a double to an int. A cast is required
        ...
        SW1A 2AA";
            ...
            // 11) all indeces in C# start at zero
            ...
            string moreLotteryNumbers = string.Format("Next weeks winning lottery numbers are {0}, {1}, {2}, {3}, {4}, {5}", win1, win2, win3, win4, win5, win6);

            // 13) The leading '$' is needed
            string evenMoreLotteryNumbers = $"Next weeks winning lottery numbers are {win1}, {win2}, {win3}, {win4}, {win5}, {win6}";
